...
WEAK_MARKET_TOP_N = _get_int("WEAK_MARKET_TOP_N", "5")
WEAK_MARKET_MIN_SCORE = _get_float("WEAK_MARKET_MIN_SCORE", "1.10")
WEAK_MARKET_MIN_VOLUME_SCORE = _get_float("WEAK_MARKET_MIN_VOLUME_SCORE", "1.2")
